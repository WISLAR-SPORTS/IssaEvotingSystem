...
class CustomUserAdmin(BaseUserAdmin):
    ...
    list_display = ("username","email","student_number","current_session_key","phone_number","first_name","last_name", "role", "institution", "branch")

    fieldsets = BaseUserAdmin.fieldsets + (
        ("Institution Info", {
            "fields": ("role", "institution", "branch")
        }),
    )
